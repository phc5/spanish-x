	...
	render() {
		return (
			<div>
				...
				<p className="aboutp">Spanish-X will help you learn Spanish using the <a href="https://en.wikipedia.org/wiki/Spaced_repetition">spaced repetition</a> method, which is a way to efficiently learn and practice new skills/concepts over an increasing period of time.</p>
